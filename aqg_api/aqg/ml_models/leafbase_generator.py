...
from .question_generation.qgna_squad_t5small import QuestionGenerator
from .distractors_generation.sense2vec_generator import Sense2VecDistractorGeneration
...
class LeafBaseMCQGenerator():
    ...
    # Main function
    def generate_mcq_questions(self, context: str, desired_count: int) -> tuple:
        ...
        return questions_list, answers_list, distractors_list
